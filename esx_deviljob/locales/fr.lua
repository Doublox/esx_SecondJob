Locales['fr'] = {
  ...
  ['alert_devil'] = 'alerte devil',
  -- Authorized Vehicles
  ['sanchez'] = 'Véhicule de ville',
  ['manchez'] = 'Opération montagne',
  ['gburrito'] = 'Véhicule de livraison',
  ['brawler'] = '4x4',
  ['cliffhanger'] = 'Tous les Devil Lost',
  ['innovation'] = 'Moto du Président',
}