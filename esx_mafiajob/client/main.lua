...
AddEventHandler('esx_mafiajob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafia' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafia' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafia' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_society:openBossMenu2', 'mafia', function(data, menu)
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafia' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then
